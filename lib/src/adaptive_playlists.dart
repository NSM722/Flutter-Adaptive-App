...
/// Uses both the width of the window (using MediaQuery.of(context).size.width),
/// and is inspecting the theme (using Theme.of(context).platform) 
/// to decide whether to display a wide layout with the SplitView widget, 
/// or a narrow display without it
